...
namespace UiSon.Attribute
{
    ...
    public class UiSonStringArrayAttribute : System.Attribute
    {
        /// <summary>
        /// The array's name.
        /// </summary>
        ...
        public UiSonStringArrayAttribute(string name, string[] array)
        {
            Name = name;
            Array = array;
        }
        ...
        public UiSonStringArrayAttribute(string name, Type enumType, Type castAs)
        {
            Name = name;
